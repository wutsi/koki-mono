...
object PageName {
    ...
    const val PAYMENT_SETTINGS_BANK = "page.payment.settings.bank"
    const val PAYMENT_SETTINGS_CASH = "page.payment.settings.cash"
    const val PAYMENT_SETTINGS_CHECK = "page.payment.settings.check"
    const val PAYMENT_SETTINGS_INTERAC = "page.payment.settings.interac"
