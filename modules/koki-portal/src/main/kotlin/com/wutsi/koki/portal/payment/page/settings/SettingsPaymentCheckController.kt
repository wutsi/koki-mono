...
class SettingsPaymentCreditCardController(
    ...
    fun edit(model: Model): String {
        ...
        val form = PaymentSettingsCreditCardForm(
            phoneNumber = configs[ConfigurationName.PAYMENT_METHOD_CREDIT_CARD_PHONE_NUMBER],
            offline = (configs[ConfigurationName.PAYMENT_METHOD_CREDIT_CARD_PHONE_NUMBER] != null),
