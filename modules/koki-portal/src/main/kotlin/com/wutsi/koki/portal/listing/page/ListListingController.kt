    ...
    private fun loadListings(): List<ListingModel> {
        return listOf(
            ListingModel(
                ...
                price = MoneyModel(amount = 250000.0, currency = "CA", text = "$250,000.00"),
            ...
            ListingModel(
                ...
                price = MoneyModel(amount = 1500.0, currency = "CA", text = "$1500,00"),
                heroImageUrl = "https://picsum.photos/600/600",
            ),
            ...
            ListingModel(
                ...
                price = MoneyModel(amount = 40000.0, currency = "CA", text = "$40,000.00"),
                heroImageUrl = "https://picsum.photos/600/600",
            ...
            ListingModel(
                ...
                price = MoneyModel(amount = 149000.0, currency = "CA", text = "$149,000.00"),
                heroImageUrl = "https://picsum.photos/600/600",
            ...
            ListingModel(
                ...
                price = MoneyModel(amount = 750.0, currency = "CA", text = "$750.00"),
                heroImageUrl = "https://picsum.photos/600/600",
            ...
            ListingModel(
                ...
                price = MoneyModel(amount = 1250000.0, currency = "CA", text = "$1,250,000.00"),
                heroImageUrl = "https://picsum.photos/600/600",
                totalActiveMessages = 2,
            ),
            ...
            ListingModel(
                ...
                price = MoneyModel(amount = 220000.0, currency = "CA", text = "$220,000.00"),
                heroImageUrl = "https://picsum.photos/600/600",
            ),
        )
    }
