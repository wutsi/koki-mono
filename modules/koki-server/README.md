...
- Java 17 or higher
- Maven 3.6 or higher
- MySQL 9.5 or compatible version
- RabbitMQ 4.2 or higher (for event publishing)
...
- `SPRING_DATASOURCE_URL`: Database connection URL (
  default: `jdbc:mysql://localhost:3306/koki?serverTimezone=UTC&useSSL=false&allowPublicKeyRetrieval=true`)
...
java -jar target/koki-server-VERSION_NUMBER-SNAPSHOT.jar
```

The server will start on `http://localhost:8080`. Access the Swagger UI at `http://localhost:8080/swagger-ui.html`.
