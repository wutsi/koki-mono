...
class SearchActivityEndpoint(
    ...
    fun search(
        ...
        @RequestParam(required = false, name = "script-id") scriptIds: List<String> = emptyList(),
        @RequestParam(required = false, name = "service-id") serviceIds: List<String> = emptyList(),
