...
open class MessagingConfiguration(
    @param:Value("\${koki.smtp.host}") private val host: String,
    @param:Value("\${koki.smtp.port}") private val port: Int,
    @param:Value("\${koki.smtp.username}") private val username: String,
    @param:Value("\${koki.smtp.password}") private val password: String,
    @param:Value("\${koki.smtp.from}") private val from: String,
) {
    @Bean
