package com.wutsi.koki.ai.server.config
...
class AIMQConfiguration(
    ...
    @Value("\${koki.module.ai.mq.queue}") private val queue: String,
    @Value("\${koki.module.ai.mq.dlq}") private val dlq: String,
    @Value("\${koki.module.ai.mq.consumer-delay-seconds}") private val consumerDelay: Int,
