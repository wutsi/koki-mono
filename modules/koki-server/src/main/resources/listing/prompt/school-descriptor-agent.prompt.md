...
- introduction: High level introduction of the neighbourhood in 1 paragraph of less than 100 words - in english. This
  paragraph will be
- introduction_fr: The introduction translated in french
  displayed in the first paragraph of the web page (max 500 words)
...
Can you describe the neighborhood Odzoa, Yaounde, generate only the markdown version with english content for
now.
