...
@Sql(value = ["/db/test/clean.sql", "/db/test/tax/ImportTaxTypeCSVEndpoint.sql"])
class ImportTaxTypeCSVEndpointTest : TenantAwareEndpointTest() {
    @Autowired
    private lateinit var dao: TaxTypeRepository
    ...
    private fun findTaxType(name: String): TaxTypeEntity {
