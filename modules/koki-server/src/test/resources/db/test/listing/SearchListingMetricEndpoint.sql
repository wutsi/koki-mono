INSERT INTO T_LISTING_METRIC(
    ...
    (102, 1, 1001, 101, 10, 3, 1, 1, 6, 8, 200000, 600000, 400000, 600, 666.67, 3200000, 'XAF'),
    (103, 1, 1002, 102, 11, 4, 2, 1, 6, 12, 150000, 450000, 300000, 800, 375.0, 3600000, 'XAF'),
    (104, 1, 1003, 103, 11, NULL, 3, 1, 6, 6, 80000, 200000, 140000, 300, 466.67, 840000, 'XAF');
