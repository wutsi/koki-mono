...
INSERT INTO T_PLACE(id, tenant_fk, created_by_fk, name, ascii_name, type, status, neighbourhood_fk, city_fk, deleted)
    VALUES (333, 1, 11, 'Westmount', 'westmount', 1, 1, 333, 111, false);
