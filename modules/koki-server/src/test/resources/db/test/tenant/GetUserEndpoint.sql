...
INSERT INTO T_USER(id, tenant_fk, type, username, email, password, display_name, status, language)
    VALUES (11, 1, 2, 'ray.sponsible', 'ray.sponsible@gmail.com', '---', 'Ray Sponsible', 1, 'fr'),
           (22, 2, 1, 'roger.milla', 'roger.milla@gmail.com', '---', 'Roger Milla', 1, 'ru');
