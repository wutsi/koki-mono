...
INSERT INTO T_USER(id, tenant_fk, username, email, password, display_name, status, language, employer, mobile, country, city_fk)
    VALUES (11, 1, 'ray.sponsible', 'ray.sponsible@gmail.com', '---', 'Ray Sponsible', 3, 'fr', 'KOKI', '+15147580000', 'ca', 111),
           (22, 2, 'roger.milla', 'roger.milla@gmail.com', '---', 'Roger Milla', 3, 'ru', null, null, null, null);
