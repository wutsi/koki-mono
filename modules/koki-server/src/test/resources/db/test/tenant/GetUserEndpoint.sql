...
INSERT INTO T_USER(id, tenant_fk, email, password, display_name, status, language)
    VALUES (11, 1, 'ray.sponsible@gmail.com', '---', 'Ray Sponsible', 1, 'fr'),
           (22, 2, 'roger.milla@gmail.com', '---', 'Roger Milla', 1, 'ru');
