...
INSERT INTO T_ACTIVITY(id, tenant_fk, active, workflow_fk, name, type, description, tags, requires_approval)
    VALUES (110, 1, true, 100, 'START', 1, 'Start the process', 'a=p1\nb=p2', true),
           (111, 1, true, 100, 'WORKING', 3, 'fill the taxes', null, false),
           (112, 1, true, 100, 'SEND', 6, null, null, false),
           (113, 1, true, 100, 'SUBMIT', 7, null, null, false),
           (114, 1, true, 100, 'STOP', 2, null, null, false);
