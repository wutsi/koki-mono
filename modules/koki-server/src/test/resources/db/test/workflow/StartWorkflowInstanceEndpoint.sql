...
INSERT INTO T_ACTIVITY(id, workflow_fk, role_fk, name, type, description, tags, requires_approval, active)
    VALUES (110, 100, null, 'START', 1, 'Start the process', 'a=p1\nb=p2', true, true),
           (111, 100, 11, 'WORKING', 3, 'fill the taxes', null, false, true),
           (112, 100, 10, 'SEND', 6, null, null, false, true),
           (113, 100, 10, 'SUBMIT', 7, null, null, false, true),
           (114, 100, null, 'STOP', 2, null, null, false, true),

           (210, 200, null, 'START', 1, null, null, false, true),
           (211, 200, null, 'WORKING', 3, null, null, false, true),
           (212, 200, null, 'END', 2, null, null, false, true),

           (310, 300, null, 'START', 1, null, null, true, true),

           (400, 400, null, 'START', 1, null, null, true, false);
