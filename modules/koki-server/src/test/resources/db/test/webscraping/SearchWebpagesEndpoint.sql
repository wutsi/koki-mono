...
INSERT INTO T_WEBPAGE(id, tenant_fk, website_fk, url, url_hash, content, image_urls, active, created_at)
    VALUES
        ...
        (201, 1, 100, 'https://example.com/listings/2', 'c81e728d9d4c2f636f067f89cc14862c', 'Listing 2 content', 'https://example.com/img2.jpg', true, now()),
        (202, 1, 100, 'https://example.com/listings/3', 'eccbc87e4b5ce2fe28308fd9f2a7baf3', 'Listing 3 content', null, false, now()),
        (203, 1, 101, 'https://test.com/properties/1', 'a87ff679a2f3e71d9181a67b7542122c', 'Property 1 content', 'https://test.com/img1.jpg', true, now());
