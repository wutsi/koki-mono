...
INSERT INTO T_OFFER_VERSION(id, tenant_fk, offer_fk, assignee_user_fk, submitting_party, price, currency, status, expires_at)
    VALUES  (1000, 1, 100, null, 1, 10000, 'CAD', 1, '2020-01-01'),
            (1001, 1, 101, 7777, 1, 10000, 'CAD', 1, null),
            (1002, 1, 102, null, 1, 10000, 'CAD', 1, '2020-01-01'),
            (1003, 1, 103, 7777, 1, 10000, 'CAD', 2, '2020-01-01');
