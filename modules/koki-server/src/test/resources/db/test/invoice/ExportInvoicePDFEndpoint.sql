...
INSERT INTO T_TENANT(id, status, name, domain_name, locale, country, number_format, currency, currency_symbol, monetary_format, date_format, time_format, date_time_format, created_at, logo_url, icon_url, portal_url, client_portal_url)
    VALUES (1, 1, 'test', 'test.com', 'en_CA', 'CA', '#,###,###.#0', 'CAD', 'CA$', 'C$ #,###,##0.00', 'yyyy-MM-dd', 'HH:mm', 'yyyy-MM-dd HH:mm', '2020-01-22 12:30', 'https://prod-wutsi.s3.amazonaws.com/static/wutsi-blog-web/assets/wutsi/img/logo/name-104x50.png', 'https://prod-wutsi.s3.amazonaws.com/static/wutsi-blog-web/assets/wutsi/img/logo/logo_512x512.png', 'https://test.com', 'https://client.test.com');
