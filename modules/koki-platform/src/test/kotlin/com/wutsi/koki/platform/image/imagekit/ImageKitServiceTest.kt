package com.wutsi.koki.platform.image.imagekit
...
import com.wutsi.koki.platform.core.image.Overlay
import com.wutsi.koki.platform.core.image.OverlayType
...
class ImageKitServiceTest {
    ...
    fun transformToWEBP() {
        ...
        assertEquals("http://www.imagekit.io/43043094/img/a/b/tr:f-webp/1.png", result)
    }
