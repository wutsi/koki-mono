...
- **AWS Account** (optional, for S3 storage and Translate services)
...
To install locally for use by other modules:
...
The JaCoCo coverage report will be available at `target/site/jacoco/index.html`.
...
Run integration tests (requires Redis and RabbitMQ):
