...
class SearchHandlerTest {
    ...
    private val metricService = mock<RoomLocationMetricService>()
...
//    @Test
//    fun bot() {
//        handler.consume(listOf(createUpdate("yo", bot = true)))
//        Thread.sleep(1000)
//
...
//    @Test
//    fun text() {
//        handler.consume(listOf(createUpdate("yo")))
//        Thread.sleep(1000)
//
//        val msg = argumentCaptor<SendMessage>()
//        verify(client).execute(msg.capture())
...
//    @Test
//    fun help() {
//        handler.consume(listOf(createUpdate("/help")))
//        Thread.sleep(1000)
//
//        val msg = argumentCaptor<SendMessage>()
//        verify(client).execute(msg.capture())
...
//
//        handler.consume(listOf(createUpdate("/search Im looking for apartment in Yaounde")))
//        Thread.sleep(1000)
//
//        verify(agent).run("Im looking for apartment in Yaounde")
//
