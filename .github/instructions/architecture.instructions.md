...
Strict Markdown Format: Use clear headings, lists, code blocks, and tables.

No Placeholders: All sections must contain a descriptive structure, even if the content is generic (e.g., instead
of [Database Choice], write PostgreSQL (Relational Store)).

Prioritize Diagrams: Always describe where diagrams belong, even if you cannot generate them (e.g., ``).
...
This section should be automatically generated and updated to reflect the document's structure.

## Overview

A concise summary of what this document covers and why the architecture was chosen

## Project Structure

This section provides a high-level overview of the project's directory and file structure, categorised by architectural
layer or major functional area.
It is essential for quickly navigating the codebase, locating relevant files, and understanding the overall organization
and separation of concerns.
Do not include files, limit the structure to directories only, and use a compact tree format.

## High-Level System Diagram

Provide a simple block diagram (e.g., a C4 Model Level 1: System Context diagram, or a basic component diagram) or a
...
List and describe the main components of the system. For each, include its primary responsibility.

## Data Stores

List and describe the databases and other persistent storage solutions used.
Do not add details about the consuming modules.
...
Provide details about the deployment strategy and infrastructure setup, if applicable.
...
- For dependencies in Maven or Gradle, do not use actual version, use VERSION_NUMBER placeholder instead.
